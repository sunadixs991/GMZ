        ...
        <div className="rounded-[2.5rem] border-2 border-blue-100 bg-gradient-to-br from-white to-blue-50 p-10 shadow-2xl sm:p-14">
          <div className="text-center">
            <p className="inline-flex items-center gap-2 rounded-full bg-blue-50 px-5 py-2 text-xs font-semibold uppercase tracking-widest text-blue-700 ring-1 ring-blue-200">
              <span className="animate-bounce">🔒</span> Privacy Policy
            </p>
          ...
          <div className="mt-14 grid gap-8 sm:grid-cols-2">
            <section className="rounded-2xl bg-blue-50/60 p-6 shadow-md border border-blue-100">
              <h2 className="text-xl font-bold text-blue-700">Information We Collect</h2>
              <p className="mt-3 text-slate-700">We collect the information you provide when you place an order, contact us, or register for our services. This may include your name, email address, phone number, shipping address, and payment details.</p>
            </section>
            <section className="rounded-2xl bg-blue-50/60 p-6 shadow-md border border-blue-100">
              <h2 className="text-xl font-bold text-blue-700">How We Use Your Information</h2>
              <p className="mt-3 text-slate-700">We use your information to process orders, respond to inquiries, provide customer support, improve our service, and send order updates. We may also use your email address to share important announcements or promotions, but only if you opt in.</p>
            </section>
            <section className="rounded-2xl bg-blue-50/60 p-6 shadow-md border border-blue-100">
              <h2 className="text-xl font-bold text-blue-700">Cookies and Tracking</h2>
              <p className="mt-3 text-slate-700">Our website may use cookies and similar technologies to improve your browsing experience, remember your preferences, and analyze site traffic. You can manage cookies through your browser settings.</p>
            </section>
            <section className="rounded-2xl bg-blue-50/60 p-6 shadow-md border border-blue-100">
              <h2 className="text-xl font-bold text-blue-700">Sharing Your Information</h2>
              <p className="mt-3 text-slate-700">We do not sell your personal information. We may share information with trusted service providers who help us operate our website, process payments, deliver orders, or support our business.</p>
            </section>
            <section className="rounded-2xl bg-blue-50/60 p-6 shadow-md border border-blue-100">
              <h2 className="text-xl font-bold text-blue-700">Security</h2>
              <p className="mt-3 text-slate-700">We take reasonable measures to protect your information from unauthorized access, disclosure, or loss. However, no online system is completely secure, and we cannot guarantee absolute protection.</p>
            </section>
            <section className="rounded-2xl bg-blue-50/60 p-6 shadow-md border border-blue-100">
              <h2 className="text-xl font-bold text-blue-700">Your Rights</h2>
              <p className="mt-3 text-slate-700">You may request access to, correction of, or deletion of your personal information. If you have questions or want to update your details, please contact us using the details below.</p>
            </section>
            <section className="rounded-2xl bg-blue-50/60 p-6 shadow-md border border-blue-100">
              <h2 className="text-xl font-bold text-blue-700">Updates to This Policy</h2>
              <p className="mt-3 text-slate-700">We may update this policy from time to time. When we do, we will post the revised version on this page with an updated effective date.</p>
            </section>
          </div>
          ...
          <div className="mt-16 rounded-3xl border-2 border-blue-100 bg-gradient-to-br from-blue-50 to-white p-8 text-slate-700 shadow-xl text-center">
            <h3 className="text-2xl font-bold text-blue-700 mb-2">Contact Us</h3>
            <p className="mb-2 text-base leading-7">If you have questions about this privacy policy, please reach out at <strong>gmzcomputertrading@gmail.com</strong> or call <strong>0924 370 6432</strong>.</p>
